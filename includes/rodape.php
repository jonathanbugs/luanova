<div id="rodape">
    <div class="container clearfix">
        <div class="blocoLinks clearfix">
            ...
            <ul class="boxLinksRodape">
                <li class="tituloBloco">Dúvidas</li>
                <li class="liLista"><a class="linkLista" href="javascript:;">FAQ</a></li>
                <li class="liLista"><a class="linkLista" href="javascript:;">Como Comprar</a></li>
                <li class="liLista"><a class="linkLista" href="javascript:;">Trocas e Devoluções</a></li>
            </ul>

             <ul class="boxLinksRodape boxLinksRodapeUltimo">
                <li class="tituloBloco">Fale Conosco</li>
