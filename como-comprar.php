...
<head>
    ...
    <!-- CSS e JS da secao -->
        ...
        <script type="text/javascript" src="js/como-comprar.js"></script>
    <!-- /CSS e JS da secao -->
</head>
        ...
        <div class="container clearfix">
            <div class="navegacaoAuxiliar clearfix">
                ...
                <ul id="migalhaPao">
                    ...
                    <li class="last"><a href="javascript:;" title="Como Comprar">Como Comprar</a></li>
                </ul>
            </div>
            <div id="blocoComoComprar" class="clearfix">
                ...
                <ul class="accordionComoComprar">
                    <li>
                        <a class="btAbrirAccordion replace" href="javascript:;">Abrir</a>
                        <h3>1 - Escolhendo os produtos</h3>
